...
public class BiciPalma {
	...
	public static void main(String[] args) {
			...
			/**/
				...
				/* caso TEST consultar bicicletas ancladas Borrar ->*/
				...
				System.out.println("ï¿½tarjeta de usuario activada? (true/false): " + estacion.leerTarjetaUsuario(tarjetaUsuario) );
