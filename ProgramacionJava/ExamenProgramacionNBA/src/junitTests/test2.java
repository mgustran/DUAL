...
public class test2 {
    ...
    CompositeItem nba = new CompositeItem("NBA");
    CompositeItem este = new CompositeItem("East");
    CompositeItem atlantic = new CompositeItem("Atlantic");
    CompositeItem central = new CompositeItem("Central");
    CompositeItem southEast = new CompositeItem("South East");
    CompositeItem oeste = new CompositeItem("West");
    CompositeItem northEast = new CompositeItem("North East");
    CompositeItem pacific = new CompositeItem("Pacific");
    CompositeItem southWest = new CompositeItem("South West");
