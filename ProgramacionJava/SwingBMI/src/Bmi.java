...
public class Bmi extends JFrame{
	private final JTextField txtMass = campoTextoBonito();
	private final JTextField txtHeight = campoTextoBonito();
	private final JButton btnCalc = makePrettyButton("Calcular BMI");
	
	private final Bmi self = this;
	...
	protected double calculateBMI(double mass, double height) {
		...
		private JTextField campoTextoBonito() {
